...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="meta_desc" select="'Alphabetisches Verzeichnis aller im Briefwechsel zwischen Hermann Bahr und Arthur Schnitzler erwähnten literarischen und künstlerischen Werke.'"/>
        <xsl:variable name="keywords" select="'Werkregister, Hermann Bahr, Arthur Schnitzler, Literatur, Werke, Dramen, Romane'"/>
        ...
        <html lang="de">
            <xsl:call-template name="html_head">
                ...
                <xsl:with-param name="current_page" select="'listwork.html'"/>
            </xsl:call-template>
            <body class="page">
