    ...
    <xsl:template match="/" name="html_footer">
        <div class="wrapper fundament-default-footer" id="wrapper-footer-full"
            ...
            <div class="container" id="footer-full-content" tabindex="-1">
                ...
                <div class="row">
                    <div class="footer-widget col-lg-3 col-md-4 col-sm-6 text-center">
                        ...
                        <p> ACDH-CH <br/> Austrian Centre for Digital Humanities and Cultural Heritage <br/> Österreichische Akademie der Wissenschaften </p>
                        <p> Bäckerstraße 13 <br/> 1010 Wien </p>
                        <p> T: +43 1 51581-2200 <br/> E: <a href="mailto:acdh-ch-helpdesk@oeaw.ac.at">acdh-ch-helpdesk@oeaw.ac.at</a> </p>
                    </div>
                    <div class="footer-widget col-lg-9 col-md-8 col-sm-6">
                        <div class="row">
                            <div class="col-md-12">
        ...
        <div class="footer-imprint-bar" id="wrapper-footer-secondary"
            style="text-align:center; padding:0.4rem 0; font-size: 0.9rem;">© Copyright OEAW | 
