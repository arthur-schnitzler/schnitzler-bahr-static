                    ...
                    <div class="container" style="margin-top:1em;">
                        <div class="row">
                            <div class="col-md-8" style="margin: 0 auto; ">
                                ...
                                <p/>
                                <p><hi>Warum diese Seite noch immer aktuell ist:</hi> 
                                    Teile der vorliegenden Edition finden sich mittlerweile auch anderswo im Netz. Das <a target="_blank"
                                        href="https://schnitzler-tagebuch.acdh.oeaw.ac.at">Tagebuch</a> Schnitzlers ist vollständig online –
                                    doch im Unterschied zu diesem sind in den von uns herausgegebenen Daten auch indirekte Erwähnungen (»Bahr und Frau«)
                                    und Organisationen indiziert und gelegentlich findet sich ein Kommentar gesetzt. Neben dem Briefwechsel
                                    Bahr – Schnitzler finden sich einige der 
                                    vorliegenden Briefe, die hier aus Buchausgaben zitiert werden, auf der
                                    Website beruflichen Korrespondenz Schnitzlers (<a target="_blank" href="https://schnitzler-briefe.acdh.oeaw.ac.at">Briefe</a>)
                                    vom Archivdokument neu ediert. Trotzdem sind hier einige Briefe ediert, die
                                    in der anderen Edition nicht aufgenommen sind, beispielsweise Briefe zwischen
                                    Schnitzler und seiner Frau. Dazu kommen Briefe an Bahr und dessen Kritiken,
                                    die ebenfalls nirgendwo sonst digital vorliegen.</p>
                            </div>
                        </div>
                    </div>
                    <div class="container" style="margin-top:1em;">
